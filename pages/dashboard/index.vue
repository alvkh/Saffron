<template>
    <div class="flex h-screen w-screen ">
        ...
        <img class="absolute opacity-10 top-[200px] -right-[140px] w-[100px] rotate-45" src="../../assets/img/pattern.svg" alt="">
        <img class="absolute opacity-10 top-[450px] -left-[140px] w-[100px] rotate-45" src="../../assets/img/pattern.svg" alt="">
        <img class="absolute opacity-10 top-[700px] -right-[140px] w-[100px] rotate-45" src="../../assets/img/pattern.svg" alt="">
            <div class="flex flex-col gap-6">
             ...
             <div class="flex gap-2 items-center mt-[430px]">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
  ...
  <path d="M15 12.75H3.62C3.21 12.75 2.87 12.41 2.87 12C2.87 11.59 3.21 11.25 3.62 11.25H15C15.41 11.25 15.75 11.59 15.75 12C15.75 12.41 15.41 12.75 15 12.75Z" fill="#C59D5F"/>
  <path d="M5.84994 16.1C5.65994 16.1 5.46994 16.03 5.31994 15.88L1.96994 12.53C1.67994 12.24 1.67994 11.76 1.96994 11.47L5.31994 8.11997C5.60994 7.82997 6.08994 7.82997 6.37994 8.11997C6.66994 8.40997 6.66994 8.88997 6.37994 9.17997L3.55994 12L6.37994 14.82C6.66994 15.11 6.66994 15.59 6.37994 15.88C6.23994 16.03 6.03994 16.1 5.84994 16.1Z" fill="#C59D5F"/>
</svg>
                <h1>خروج</h1>
            </div>   
            </div>
        ...
        <div class="flex flex-col w-[80%]  ">
            <div class="w-full items-center gap-8 justify-between  px-8 flex h-[80px] bg-[#0E1317]">
...
<h2 class="font-peyda-bold text-[18px] p-1 px-2">حساب کاربری</h2>
                ...
                <div class="flex !z-20 gap-2 items-center bg-[#3B3B3B] p-[6px] rounded-lg">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
  <path d="M11 20.75C5.62 20.75 1.25 16.38 1.25 11C1.25 5.62 5.62 1.25 11 1.25C16.38 1.25 20.75 5.62 20.75 11C20.75 16.38 16.38 20.75 11 20.75ZM11 2.75C6.45 2.75 2.75 6.45 2.75 11C2.75 15.55 6.45 19.25 11 19.25C15.55 19.25 19.25 15.55 19.25 11C19.25 6.45 15.55 2.75 11 2.75Z" fill="#C59D5F"/>
  <path d="M20.1601 22.79C20.0801 22.79 20.0001 22.78 19.9301 22.77C19.4601 22.71 18.6101 22.39 18.1301 20.96C17.8801 20.21 17.9701 19.46 18.3801 18.89C18.7901 18.32 19.4801 18 20.2701 18C21.2901 18 22.0901 18.39 22.4501 19.08C22.8101 19.77 22.7101 20.65 22.1401 21.5C21.4301 22.57 20.6601 22.79 20.1601 22.79ZM19.5601 20.49C19.7301 21.01 19.9701 21.27 20.1301 21.29C20.2901 21.31 20.5901 21.12 20.9001 20.67C21.1901 20.24 21.2101 19.93 21.1401 19.79C21.0701 19.65 20.7901 19.5 20.2701 19.5C19.9601 19.5 19.7301 19.6 19.6001 19.77C19.4801 19.94 19.4601 20.2 19.5601 20.49Z" fill="#C59D5F"/>
                    ...
                    <input class=" bg-transparent  text-[18px] caret-[#C59D5F] focus:outline-none placeholder:text-[#C59D5F] placeholder:font-peyda-bold" placeholder="جستجو"  type="text">
                </div>
            </div>
            <div class="flex  flex-col gap-4">
                <slider1></slider1>
            </div>
            <div class="bg-[#0E1317] flex p-4 mr-[20px] w-[95%] mt-4 mx-auto h-[400px] shadow-[#C59D5F]  shadow rounded-lg ">
                <div class="flex w-[20%] h-full flex-col font-peyda-bold text-[18px] justify-between py-[60px] px-10 text-[#C59D5F]">
                    <h2>زعفران 1</h2>
                    <h2>زعفران 2</h2>
                    <h2>زعفران 3</h2>
                    <h2>زعفران 4</h2>
                ...
                <div class="h-full justify-center flex">
                    <img class="rounded-lg img-fadebanner" src="../../assets/img/chart.jpg" alt="">
                </div>
            </div>
            <div class="flex ">
                <div class="flex"></div>
