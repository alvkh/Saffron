<template>
    <div>
        <svg @onmouseover="changecolor1('#C59D5F')" @mouseleave="changecolor1('#ffffff')"
            xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            <path id="locationpath1"
...
<script setup>
    function changecolor1(color) {
        document.getElementById("locationpath1").setAttribute("fill", color);
        // document.getElementById("locationpath2").setAttribute("fill", color)
    }
</script>